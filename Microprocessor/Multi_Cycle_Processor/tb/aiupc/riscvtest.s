...
test_auipc:
    auipc x10, 1            # x10 = PC + 0x1000 (At address 0x50, x10 = 0x1050)   50        00001517
    sw    x10, 104(x0)      # [104] = 0x1050 (Write to memory to verify)          54        06A02423
done:
    beq   x0, x0, done      # infinite loop                                       58        00000063
