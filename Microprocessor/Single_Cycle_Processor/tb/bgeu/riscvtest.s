...
#   add, sub, and, or, slt, addi, lw, sw, beq, jal, bgeu
# If successful, it should write the value 25 to address 100, 
# and then the value 25 to address 104.
#
...
# --- NEW BGEU TEST ---
    bgeu x2, x5, pass          # 25 >= 11, should branch      50        00517463
    addi x2, x0, 0             # shouldn't execute (fail)     54        00000113

pass:
    sw   x2, 104(x0)           # [104] = 25 (Success)         58        06202423

done:
    beq  x2, x2, done          # infinite loop                5C        00210063
